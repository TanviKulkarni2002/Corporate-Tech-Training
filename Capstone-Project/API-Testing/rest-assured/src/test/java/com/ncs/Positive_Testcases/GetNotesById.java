...
public class GetNotesById {
    ...
    @Test
    public void retrieveNoteById(){
        RestAssured.baseURI = "https://practice.expandtesting.com/notes/api";
        String noteId = "670ab7f1a27c690158be389e"; // Note ID to retrieve
        ...
        Response response = given()
                            ...
                            .then()
                                ...
                                .body("message", equalTo("Note successfully retrieved")) // Check the message field
                                .extract().response();
